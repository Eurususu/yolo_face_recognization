...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../weights/yolov7-tiny.pt', help='weights path')
    parser.add_argument('--img-size', nargs='+', type=int, default=[736, 1280], help='image size')  # height, width
    ...
    parser.add_argument('--export-nms', action='store_false', help='export the nms part in ONNX model')  # ONNX-only, #opt.grid has to be set True for nms export to work
